...
def run_react_agent(user_query: str, provider, mcp_server: MCPAcademicServer) -> list:
    ...
    # Kết quả Tool của các bước trước, dùng làm Observation cho bước kế tiếp.
    observations = []
    ...
    while step < MAX_ITERATIONS:
        ...
        # Trường hợp 2: LLM đề xuất gọi Tool (Action)
            ...
            # Luôn đưa Observation cho LLM ở lượt sau để Agent có thể tiếp tục
            # chuỗi nhiều bước (ví dụ: tra cứu cố vấn rồi mới đặt lịch).
            ...
            # Không break ở đây: vòng lặp tiếp tục để LLM đọc Observation,
            # gọi Tool tiếp theo hoặc tạo Final Answer.
